...
import fot_logo from "../assets/fot_logo.webp"
const Footer = () => {
    ...
    return (
        <footer className="bg-gray-100 py-8 px-4 md:px-8 lg:px-12 relative">
            <div className="container px-10 flex flex-col justify-center items-center mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className=" h-full flex items-center col-span-1">
                        <div className="flex items-center justify-center mb-4">
                            <div className=" items-center rounded-lg p-2 mr-2">
                                <a href="/" className="flex items-center">
                                    <img src={fot_logo} alt="Logo" className=" h-[12vh] md:h-[20vh] w-[auto]  " />
                                </a>
                            </div>
                    ...
                    <div className="col-span-1">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><a href="#" className="text-gray-600 hover:text-orange-600 transition">Dal & Nuts</a></li>
                            <li><a href="#" className="text-gray-600 hover:text-orange-600 transition">Fariyali</a></li>
                            <li><a href="#" className="text-gray-600 hover:text-orange-600 transition">Bhel</a></li>
                            <li><a href="#" className="text-gray-600 hover:text-orange-600 transition">Nukti Mix</a></li>
                            <li><a href="#" className="text-gray-600 hover:text-orange-600 transition">Gathiya Papdi</a></li>
                            <li><a href="#" className="text-gray-600 hover:text-orange-600 transition">Masala Snacks</a></li>
                        </ul>
                    </div>

                    {/* Quick Links */}
                    <div className="col-span-1">
                        <h3 className="text-lg font-semibold text-gray-700 mb-4 border-b border-orange-400 pb-2">Quick Links</h3>
                        <ul className="space-y-3">
                            <li><a href="#" className="text-gray-600 hover:text-orange-600 transition">About Us</a></li>
                            <li><a href="#" className="text-gray-600 hover:text-orange-600 transition">Products</a></li>
                    ...
                    <div className="col-span-1">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-gray-700 mb-4">Subscribe to Our Mahendra Namkeen</h3>
                            <div className="flex">
                                <input
                                    type="email"
                ...
                {/* Copyright Section */}
                <div className="border-t border-gray-200 mt-12 pt-6 text-center md:text-left md:flex md:justify-between md:items-center">

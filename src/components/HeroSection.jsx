            ...
            <div className="py-8 md:py-12 lg:py-16">
                <div className="bg-orange-50 rounded-md p-4 md:p-8 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div className="w-full md:w-1/2 mb-6 md:mb-0">
                        <div className="text-orange-600 font-medium text-sm md:text-base lg:text-lg mb-2">WELCOME TO MAHENDRA NAMKEEN</div>
                    ...
                    <div className="w-full md:w-1/2 flex justify-center md:justify-end">
                        <img
                            ...
                            className="max-w-full rounded-xl h-auto w-64 md:w-96 lg:w-[420px]"
                        />
                    </div>
                </div>
            </div>

...
const PopularProducts = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-4xl font-bold text-gray-800 mb-4">Popular Products</h1>
                ...
                {products.map((product) => (
                    <div key={product.id} className="border border-gray-200 rounded-lg overflow-hidden">
                        ...
                        <div className="relative bg-gray-100 p-4">
                            <div className="absolute top-2 left-2 bg-yellow-400 text-black font-medium px-2 py-1 rounded-sm">
                                -{product.discount}%
                            </div>
                            <img
                                src={product.image}
                        ...
                        <div className="p-4">
                            ...
                            <div className="flex items-center">
                                ...
                                <button className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-800 py-2 px-4 rounded-md transition-colors">
                                    Add to cart
                                </button>
                            </div>
                        </div>
